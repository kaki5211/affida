...
const headers = ref([
          { title: headers_name, align: 'start', key: 'name', value: 'name' },
...
<!-- 
  ...
  >
    <template v-slot:item.name="{ item }">
      <!-- <router-link :to="{ name: SUBCONTENTS.charAt(0).toUpperCase() + SUBCONTENTS.slice(1), params:{param:item.selectable.name_eng }  }"> -->
