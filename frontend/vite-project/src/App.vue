...
const routes = [
  ...
  { path: '/label', name: 'Labels' },
  { path: '/label/:param', name: 'Label' },
  { path: '/series', name: 'Seriess' },
  { path: '/series/:param', name: 'Series' },
...
store.commit('SET_URL_JUDGE_PARAM', url_judge_param.value)
